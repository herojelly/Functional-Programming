...
def main():
    print("This program determines the validity of a date.")
    invalidMonth = 0
    invalidYear = 0
    invalidDay = 0
    ...
    try:
        ...
        # Prints a statement if the year is valid
        if invalidMonth == 0 and invalidDay == 0 and invalidYear == 0:
            print("After a million tests, it turns out that's a valid year.")
